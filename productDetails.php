...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class='fullpage'>
            <div class='images'>
                <img class='main' src='./backend/".$product['primaryimg']."' alt='".$product['pname']."'>
                <div class='small-images'>
                    <img class='bottom-image' src='./backend/".$product['primaryimg']."' alt='".$product['pname']."'>
                    <img class='bottom-image' src='./backend/".$product['pic2']."' alt='".$product['pname']."'>
                    <img class='bottom-image' src='./backend/".$product['pic3']."' alt='".$product['pname']."'>
                    <img class='bottom-image' src='./backend/".$product['primaryimg']."' alt='".$product['pname']."'>
                </div>
            </div>
                ...
                <div class='total-products'>
                    ...
                    <div class='quantity-container'>
                        ...
                        <div class='left-items'>
                            <p>only <span style='color: rgb(230, 130, 9);'>".$product['quantity']." items</span> Left! Don't miss out!</p>
                        </div>
                    </div>
                    <div class='action'>
